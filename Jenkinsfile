	...
	stages{	
		...
		stage("Deploy to Tomcat"){
			steps{
				...
				sh "cp ${WORKSPACE}/ansible-playbooks/nexus-to-tomcat/java-hello-world-webapp-${CURRENT_VERSION}.war ${WORKSPACE}/ansible-playbooks/nexus-to-tomcat/roles/deploy-to-tomcat/files/"
